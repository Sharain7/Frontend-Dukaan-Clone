export const RevenueCard = ({
    ...
    return <div className="bg-white rounded shadow-md p-4">
        <div className="text-gray-700 flex justify-content">
        ...
        <div className="flex justify-between pt-2 ">
            ...
            {orderCount ? <div className="font-medium text-blue-500 underline decoration-blue-500 cursor-pointer flex  justify-content">
                <div className="flex">
                    {orderCount} order(s)
